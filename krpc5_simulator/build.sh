...
# no gui(default)
export baseImage="osrf/ros:noetic-desktop-full"
export astrobeeBaseTag="krpc/astrobee:base-v0.17.1-ubuntu20.04"
export astrobeeTag="krpc/astrobee:v0.17.1-ubuntu20.04"
export krpcBaseTag="krpc/astrobee_sim-base:5.0.0"
export krpcRandomTag="krpc/astrobee_sim-random:5.0.0"
...
if [ -n "${gui}" ]; then
    ...
    export krpcBaseTag="krpc/astrobee_sim-base-with-gui:5.0.0"
    export krpcRandomTag="krpc/astrobee_sim-random-with-gui:5.0.0"
fi
